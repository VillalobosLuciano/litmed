...
function Navbar({ siteTitle }) {
  ...
  return (
    <header className="sticky top-0 z-10 px-4 py-2 border-b-2 shadow-xl border-primary-500 bg-secondary-700 sm:flex sm:justify-between sm:items-center sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
