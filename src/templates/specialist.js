                ...
                <div className="order-3 w-8 pb-2 mx-2 md:order-first md:mx-4">
                  {prevPostURL && (
                    <Link
                      ...
                      className="inline-block w-10 h-10 px-2 text-white hover:text-teal-500"
                      to={`${prevPostURL
                        .normalize("NFD")
                        .replace(/[\u0300-\u036f]/g, "")}`}
                    >
                  ...
                  <div className="p-4 lg:p-8" name="modalContent">
                    ...
                    <div className="mt-4 sm:mt-0">
                      <div className="flex justify-between mb-1">
                        ...
                        <button>
                          <Link to={closeTo}>
                            <FaTimes className="w-8 h-8 text-gray-400 transition-colors duration-200 fill-current hover:text-teal-500" />
                          </Link>
                        </button>
                      </div>

                      <p className="text-sm font-semibold leading-6 tracking-wide text-teal-600 uppercase">
                        {specialty}
                      </p>
                    </div>
                    ...
                    <div className="mb-2 lg:flex">
                      <div className="lg:w-2/3">
                        <div className="mt-4 sm:mb-8">
                          ...
                          <h5 className="text-sm leading-6 text-teal-800 uppercase">
                            Experiencia
                          </h5>
                          <PostContent
              ...
              <div className="mb-6 lg:flex">
                <div className="lg:w-2/3">
                  <div className="mt-4 sm:mt-6 sm:mb-8">
                    <h5 className="tracking-wide text-teal-800 font-base">
                      Descripción
                    </h5>
                    <p className="mt-1 mb-4 font-light">{description}</p>
                    <h5 className="tracking-wide text-teal-800 font-base">
