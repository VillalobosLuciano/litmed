...
class EspecialistCard extends React.Component {
  render() {
...
export default () => (
  <StaticQuery
    ...
    `}
    render={(data, count) => <EspecialistCard data={data} count={count} />}
  />
)
